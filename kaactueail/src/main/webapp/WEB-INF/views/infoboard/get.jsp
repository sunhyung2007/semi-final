			...
			<div class="main_contents">
				...
				<div class="layout_content">
					<div style="width: 18rem; text-align: center; margin: auto;">
						<img src="${path}/resources/images/cocktailInfoImage/${pageInfo.infoboardTitle}.png" class="card-img-top" alt="NO IMAGE" width=350px, height=230px style="cursor: pointer;">
					</div>

	...
	<div class="wrapper">
		<div class="contents">
			<div class="main_contents">
				...
				<h1>글쓰기</h1>
				<form action="/mycocktailboard/write" method="post">
					<div class="btn_wrap" style="float: right;">
						<button type="submit" class="btn btn-dark" id="write_btn">글쓰기</button>
						<button type="submit" class="btn btn-dark" id="list_btn" onclick="location.href='list'" formaction="/mycocktailboard/mycocktailboardlist" formmethod="get">목록</button>
					</div>
					<div class="form-group">
						<label class="col-form-label mt-4" for="inputDefault">제목</label>
						<input type="text" class="form-control" placeholder="제목을 입력하세요"
							id="inputDefault" name="mycocktailTitle" required>
					</div>
					<div class="form-group">
						<label class="col-form-label mt-4" for="inputDefault">작성자</label>
						<input type="text" class="form-control" placeholder="작성자를 입력하세요"
							id="inputDefault" name="mycocktailWriter" required>
					</div>
					<div class="form-group">
						<label for="exampleTextarea" class="form-label mt-4">내용</label>
						<textarea name="mycocktailContent" class="form-control" id="exampleTextarea"
							rows="15" placeholder="내용을 입력하세요" required></textarea>
					</div>
					<div class="form-group">
						<label for="exampleTextarea" class="form-label mt-4">레시피</label>
						<textarea name="mycocktailRecipe" class="form-control" id="exampleTextarea"
							rows="15" placeholder="레시피를 입력하세요" required></textarea>
					</div>
					<div class="form-group">

...
<%@ include file="../layout/header.jsp"%>
	...
	<h3>비밀번호 찾기</h3>
	<div class="findpwd_wrap" style="padding: 12% 25%">
		<form action="findpwd" method="POST">
			<div class="form-floating mb-3">
				<input type="text" class="form-control" id="floatingInput" name="mId" placeholder="ID" >
			...
			<div class="form-floating mb-3">
				...
				<div style="display: grid">
					<button type="submit" class="btn btn-secondary" style="padding: 1.5% 0 1.5%;">비밀번호 찾기</button>
				</div>
		</form>
	</div>

      ...
      <div class="contents">         
         <div class="main_contents">   
            ...
            <div class="myCocktail" style="">
               <div class="myCockList" style="float: left; width:1200px;">
                  <h2 style="width: 1200px; float: left; margin: 10px;">나만의 칵테일</h2>
                  <div
                     style="justify-content: space-between; flex-wrap: wrap; display: flex; width: 1200px; float: left;">
                     ...
                     <c:set var="i" value="${i+1}"/>                     
                        <div class="card"
                           ...
                           <img class="card-img-top"
                              ...
                              src="${path}/resources/images/mycocktailImagefolder/${mycocktailboardlist.mycocktailImgName}"
            ...
            <div class="cockInfo" style="width: 1000px; height:500px;">
            <h2 style="width:500px;float:left; margin:10px;">칵테일 정보</h2>               
                  ...
                  <c:forEach var="cocklist" items="${cockInfoList}">
                     <div class="card" style="width: 18rem">
                        <a class="move" href='/infoboard/get?infoboardNum=<c:out value="${cocklist.infoboardNum }"/>'>
                           ...
                           class="card-img-top" alt="NO IMAGE" width=150px, height=150px

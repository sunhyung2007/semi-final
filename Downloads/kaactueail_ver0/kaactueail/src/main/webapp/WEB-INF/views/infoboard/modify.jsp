			...
			<div class="main_contents">
				...
				<form action="/infoboard/modify" id="modifyForm" method="post">
					<div class="btn_wrap">
						...
						<button type="submit" class="btn btn-dark" id="delete_btn" onclick="loaction.href='delete'" formaction=" " formmethod="post">삭제</button>
					</div>					
				...
				<div class="layout_all">
					...
					<div class="layout_middle">
						...
						<div class="text-secondary" id="writedate">
							<p><fmt:formatDate pattern="yyyy.MM.dd" value="${pagemodify.infoboardDate}" /></p>
						</div>
						<div>
